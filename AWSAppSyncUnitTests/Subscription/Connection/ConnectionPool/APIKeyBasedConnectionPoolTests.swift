...
class APIKeyBasedConnectionPoolTests: XCTestCase {

    var connectionPool: APIKeyBasedConnectionPool!
    ...
    /// - Then:
    ///    - I should get non-nil connections for each request. And the internal count of provider should be the same.
    ///
