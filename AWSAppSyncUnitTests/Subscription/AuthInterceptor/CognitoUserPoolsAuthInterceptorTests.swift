...
class CognitoUserPoolsAuthInterceptorTests: XCTestCase {

    var authInterceptor: CognitoUserPoolsAuthInterceptor!

    override func setUp() {
        authInterceptor = CognitoUserPoolsAuthInterceptor(MockUserPoolsAuthProvider())
    }
