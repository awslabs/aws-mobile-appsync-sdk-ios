...
public struct SubscriptionWithSyncConfiguration {
    ...
    /// Creates a new SubscriptionWithSyncConfiguration with the specified sync interval.
    ///
    /// - Parameters:
    ///   - syncIntervalInSeconds: The sync interval. Defaults to one day (86,400 seconds)
    init(syncIntervalInSeconds: Int = 86_400) {
