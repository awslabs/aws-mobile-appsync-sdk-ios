...
public class ApolloClient {
    ...
    private static var defaultApolloClient: ApolloClient? = nil
    public class var defaultClient: ApolloClient {
        get {
            return defaultApolloClient!
        }
        set {
            defaultApolloClient = newValue
        }
    }
    ...
    public func getOfflineMutationQueue() {
        
    }
    
    /*
    public func saveObject<Object: DataObject>(object: Object, operationType: String, operationString: String, resultHandler: DataObjectResultHandler<Object>? = nil, queue: DispatchQueue = DispatchQueue.main) {
        sendDataObjectRequest(object: object, operationType: operationType, operationString: operationString, handlerQueue: queue, resultHandler: resultHandler)
    }
    
    fileprivate func sendDataObjectRequest<Object: DataObject>(object: Object, operationType: String, operationString: String, handlerQueue: DispatchQueue, resultHandler: DataObjectResultHandler<Object>? = nil) -> Cancellable {
        
        func notifyResultHandler(resultObject: DataObject?, error: Error?) {
        ...
        return networkTransport.send(object: object, operationType: operationType, operationString: operationString) { (responseObject, error) in
        
            guard let responseObject = responseObject else {
                notifyResultHandler(resultObject: nil, error: error)
                return
            }
